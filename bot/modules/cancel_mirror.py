    ...
    if len(args) > 1:
        ...
        with download_dict_lock:
            ...
            try:
                ...
                pass
    if len(args) == 1:
        msg = f"من فضلك قم بالرد علي رسالة <code>/{BotCommands.MirrorCommand}</code> التي استخدمت لبدأ عمل الميرور او ارسل <code>/{BotCommands.CancelMirror} والرقم التعريفي بتاع العملية</code> عشان تلغيها!"
...
def cancel_all(update, context):
    ...
    while True:
        ...
        if dl:
            ...
            break
    sendMessage(f'تم ايقاف {count} تحميلات!', context.bot, update)
